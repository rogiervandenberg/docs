...
Please note for now `db pull` will only introspect views in your schema when using PostgreSQL, MySQL, SQL Server or CockroachDB. Support for this workflow will be extended to other database providers soon.
...
This is a temporary limitation and support for introspection will be extended soon to the other supported datasource providers.
